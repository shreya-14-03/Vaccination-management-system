...
public class aboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public aboutUs() {
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("vaccine/management/system/icons/logo.png"));
            ...
            JLabel l6 = new JLabel("Developed By : Shreya Sharma");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Us : shreyasharma14032000@gmail.com");
